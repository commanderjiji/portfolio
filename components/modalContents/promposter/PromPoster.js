...
import poster from "./promposter.png";

//* Header */
export const header = "Senior's Night Poster";
...
//* Body */
export const bodyContent = <p className="mb-8">A poster I created during senior high school for our Senior's Night.</p>;
...
export default function PromPoster() {
	return (
		<div>

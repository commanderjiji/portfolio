...
import poster from "./nailposter.png";

//* Header */
export const header = "Nail Poster";
...
//* Body */
export const bodyContent = <p className="mb-8">This was my poster entry for a job posting in graphic design.</p>;
...
export default function NailPoster() {
	return (
		<div>
			{/* <ModalCarousel /> */}

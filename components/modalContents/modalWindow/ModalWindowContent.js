...
import image1 from "./modalwindow1.png";
import image2 from "./modalwindow2.png";
...
export const bodyContent = (
	<p>
		...
		<br />
		Source:{" "}
		<a className="hover:underline" href="https://developer.mozilla.org/en-US/docs/Web/API/Document_Object_Model" target="_blank">
...
export default function ModalWindowContent() {
	return (
		<div>
			<ModalCarousel />
			{bodyContent}

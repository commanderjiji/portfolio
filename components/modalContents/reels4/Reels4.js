...
//* Body */
export const bodyContent = <p className="mb-8">A POV of a daily commuter inside a jeepney in the Philippines.</p>;
...
export default function Reels4() {
	return (
		<div>
			<div className="flex justify-center mb-5">
				<InstagramEmbed url="https://www.instagram.com/reel/C-jhx2XSjNc/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==" width={328} />
			</div>
			{bodyContent}
		</div>
	);

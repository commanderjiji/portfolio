...
//* Body */
export const bodyContent = <p className="mb-8">Our trip to the Queen City of the South, Cebu, Philippines.</p>;
...
export default function Reels3() {
	return (
		<div>
			<div className="flex justify-center mb-5">
				<InstagramEmbed url="https://www.instagram.com/reel/CwpxV0iv8IS/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==" width={328} />
			</div>
			{bodyContent}
		</div>
	);

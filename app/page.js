...
export default function Home() {
  ...
  dark:[&::-webkit-scrollbar-thumb]:bg-[#1B2B46]"
				...
				<section className="mb-20 h-full lg:h-modalH">
					...
					<div className="lg:flex  bg-cyan-400">
						<div className="flex flex-col items-center text-center justify-center p-5 lg:pl-8">
							...
							<div className="mb-5  ">
								...
								<p className="text-xs lg:text-md  text-gray-800 dark:text-gray-200  ">Aspiring Front-End Developer • Graphic Designer</p>
							</div>
				...
				<section className=" mb-20 bg-purple-600">
					...
					<div className=" container my-5 pl-8 ">
						<sectiontext-xs>
							<p className="text-sm mb-12 lg:w-3/5 dark:text-white">I’m excited to connect! Whether it’s for project discussions, collaboration opportunities, or any inquiries, don’t hesitate to reach out—I’d be glad to help!</p>
											...
											<a href="mailto:jeromealmoguera@gmail.com" target="_blank">
												<div className="flex items-start">
													...
													<div className="ml-6 grow">
														<p className="text-neutral-500 font-semibold  text-xs">Email</p>
														<p className="dark:text-white hover:underline font-light text-xs">jeromealmoguera@gmail.com</p>
													</div>
												</div>
											</a>
										</div>
										...
										<div className="mb-4 lg:mb-8 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6">
											<a href="https://github.com/jeromealmoguera" target="_blank">
												<div className="flex items-start">
													...
													<div className="ml-6 grow">
														<p className="text-neutral-500 font-semibold  text-xs">GitHub</p>
														<p className="dark:text-white hover:underline font-light text-xs">@jeromealmoguera</p>
													</div>
												</div>
											</a>
										</div>
										...
										<div className="mb-4  w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6">
											<a href="https://www.linkedin.com/in/jeromealmoguera/" target="_blank">
												<div className="align-start flex">
													...
													<div className="ml-6 grow">
														<p className="text-neutral-500 font-semibold  text-xs">LinkedIn</p>
														<p className="dark:text-white hover:underline font-light text-xs">@jeromealmoguera</p>
													</div>
												</div>
											</a>
										...
										<div className="mb-4  w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6">
											<a href="https://www.instagram.com/almoguerajeromeg/" target="_blank">
												<div className="align-start flex">
													...
													<div className="ml-6 grow">
														<p className="text-neutral-500 font-semibold text-xs">Instagram</p>
														<p className="dark:text-white  hover:underline font-light text-xs">@almoguerajeromeg</p>
													</div>
												</div>
											</a>
										</div>
				...
				<section className="border-y mb-5 lg:mb-12">
					<div className="justify-items-center h-screen content-center">
						<h1 className="font-main text-7xl lg:text-10xl tracking-tighter leading-none dark:text-white ">THANKS</h1>
						<p className="font-mainLight lg:text-5xl tracking-widest pl-5 lg:pl-12 dark:text-white ">FOR VISITING</p>
					</div>
				</section>
				...
				<section>
					<div className="max-w-screen-xl px-4 py-5 mx-auto space-y-2 overflow-hidden sm:px-6 lg:px-8 ">
						...
						<p className=" font-extralight text-xs text-center text-dark-blue dark:text-white/75 ">
							...
							<a href="https://www.linkedin.com/in/jeromealmoguera/" target="_blank" title="Connect with Jerome Almoguera on LinkedIn" className="text-xs underline  underline-offset-1 hover:dark:text-white">
								Jerome Almoguera
							</a>
						</p>
					</div>
